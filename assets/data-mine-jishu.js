...
<p>“工具层面，内置了 9 个核心工具：文件读写、命令执行、代码搜索、目录浏览、web 搜索。通过 MCP 协议还可以接入外部工具，比如浏览器操作、数据库查询这些。”</p>` },
      { "t": "腾讯一面 · 02、有实现 Sub-agent 吗？怎么编排的？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王追问：“多 Agent 场景下你是怎么编排的？”</p>
...
<p>“每个执行者有独立的消息历史和 Skill 上下文缓冲区。并行执行时，输出各自写入独立的字节缓冲区，全部完成后再按原始顺序合并到终端，保证展示不会乱序。”</p>` },
      { "t": "腾讯一面 · 03、支持后台任务吗？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王问：“前台跑 Agent 的时候能同时跑后台任务吗？”</p>
...
<p>“启动时还有崩溃恢复：扫描所有 running 状态但租约已过期的任务，重置为 queued 重新排队。这样即使进程异常退出，未完成的任务也不会丢。”</p>` },
      { "t": "腾讯一面 · 04、Sub-agent 也支持 Plan 模式吗？Skill 怎么调用？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王问：“Multi-Agent 里的执行者，能不能走 Plan 模式？”</p>
...
<p>因为 Skill 内容注入后会从缓冲区清空（drain 操作），如果多个 Sub-agent 共享同一个缓冲区，一个 Worker 的 drain 会把另一个 Worker 还没读到的内容清掉。</p>` },
      { "t": "腾讯一面 · 05、Skill 分层体系是怎么做的，为什么这么设计？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王说：“Skill 系统展开说说。”</p>
...
<p>这个思路和 Claude Code 的设计一脉相承，Claude Code 也是内置 Skill、用户 Skill、项目 Skill 三层。</p>` },
      { "t": "腾讯一面 · 06、用户输入怎么和 Skill 匹配？有积累机制吗？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王追问：“用户输入一段话，怎么知道该加载哪个 Skill？”</p>
...
<hr>` },
      { "t": "腾讯一面 · 07、长短期记忆怎么设计的？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王换了个方向：“Agent 的记忆系统怎么做的？”</p>
<p>我说：“三层。”</p>
...
<p>“长期静态记忆就是 PAI.md 文件。项目根目录或 .paicli 目录下放一个 PAI.md，启动时自动加载到系统提示词里。功能类似 Claude Code 的 CLAUDE.md。”</p>` },
      { "t": "腾讯一面 · 08、为什么要分静态长期记忆和动态长期记忆？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王追问：“为什么不统一成一种？”</p>
<p>“用途不同。”</p>
...
<p>两者在 Prompt 组装时合并注入系统提示词，静态的先加载、动态的后加载。</p>` },
      { "t": "腾讯一面 · 09、什么时候触发记忆存储？会不会越存越多？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王问：“长期记忆是怎么触发存储的？膨胀怎么控制？”</p>
...
<p>“召回阈值设定为 0.05。这个值很低，因为宁可多召回几条不太相关的，也不要漏掉真正有用的。LLM 自己能判断哪些记忆和当前任务有关，不需要评分系统做太严格的过滤。”</p>` },
      { "t": "腾讯一面 · 10、上下文压缩机制是怎么做的？", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王问：“对话太长，上下文窗口装不下怎么办？”</p>
...
<p>“token 估算用经验公式：中文字符按 1 token/字，英文按 3 个字符 1 个 token。偏保守，代码多的场景会高估。但高估比低估安全，低估可能导致请求超出模型窗口被截断。”</p>` },
      { "t": "腾讯一面 · 11、讲一下动态 Prompt 和静态 Prompt", "tag": "技术派·腾讯一面", "p": "core", "html": `` },
      { "t": "腾讯一面 · 文章导读与背景", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王说：“你的系统提示词是怎么组装的？”</p>
<p>“分成静态部分和动态部分。”</p>
...
<p>总预算 16KB，超出截断。用户还可以自定义覆盖任意一层的提示词文件，覆盖是整文件替换。</p>` },
      { "t": "腾讯一面 · 12、模型底座是哪个？成本怎么样？你平时用 PaiCLI 吗？", "tag": "技术派·腾讯一面", "p": "core", "html": `<p>老王抛出最后的问题：“你用的什么模型？成本算过吗？”</p>
...
<blockquote>
 <p>GitHub 地址：<a href="https://github.com/itwanger/PaiCLI-Python">https://github.com/itwanger/PaiCLI-Python</a></p>
      ...
      { "t": "拼多多 · 02、三层记忆架构为什么这么设计？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王问：“Agent 的记忆架构是怎么分层的？为什么要这么分？”</p>
...
<p>“因为 LLM 的上下文窗口是有限资源。短期记忆解决‘当前对话不丢’的问题，长期记忆解决‘跨会话能想起来’的问题，检索层解决‘该想起哪些’的问题。三层各管各的，互不干扰。”</p>` },
      { "t": "拼多多 · 03、文件作为事实源，为什么不直接用 RAG / 向量数据库存？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王追问：“长期记忆用 JSON 文件存？为什么不上向量数据库？”</p>
...
<p>JSON 文件的写入是同步的，每次 store 操作完成后数据就在磁盘上了。如果用向量数据库，还得等 embedding 计算、索引更新，延迟和复杂度都上来了。</p>` },
      { "t": "拼多多 · 04、文件作为事实源，怎么保证时效性和一致性？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王问：“那文件存储怎么保证数据不过期、不冲突？”</p>
<p>我说：“时效性靠两个机制。”</p>
...
<p>每条记忆有一个 scope 字段，分 project 和 global 两种。项目级别的事实只在对应项目路径下可见，全局偏好才跨项目共享。检索时会按项目路径做可见性过滤，避免 A 项目的事实污染 B 项目的上下文。</p>` },
      { "t": "拼多多 · 05、文件太大时，索引不能每次读全文，怎么办？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王点点头，接着问：“记忆文件越来越大，全量加载不现实，怎么办？”</p>
<p>两个层面。</p>
...
<p>这意味着即使长期记忆有 500 条，注入到 LLM 上下文的也就十来条。</p>` },
      { "t": "拼多多 · 06、Agent 是怎么调用工具的？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王说：“记忆聊清楚了，说说工具调用。Agent 是怎么调工具的？”</p>
...
<p>LLM 不关心工具是内置的还是 MCP 的，它只看工具定义列表里的名称和参数描述。</p>` },
      { "t": "拼多多 · 07、Agent 怎么去判断是否需要调用工具？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王问：“那判断调不调工具，是 Agent 的逻辑还是 LLM 的逻辑？”</p>
...
<p>“这就是 Function Calling 的核心理念——工具选择权交给模型。Agent 是执行者，不是决策者。”</p>` },
      { "t": "拼多多 · 08、工具调用失败时，怎么保证 Agent 不死循环或乱回答？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王紧跟着追问：“万一工具调用失败了呢？Agent 会不会反复重试、陷入死循环？”</p>
<p>我说：“不会，有三道防线。”</p>
...
<p>“第三道是多 Agent 模式下的 Reviewer 审查。如果用的是多 Agent 协作模式，每个步骤执行完后会经过 Reviewer 审查。Reviewer 判定不合格的步骤最多重试 2 次，超过次数保留当前结果并标记步骤状态，不会无限重试。”</p>` },
      { "t": "拼多多 · 09、有没有做防止反复存储无意义记忆的预防机制？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王问：“前面提到长期记忆会自动提取事实。那 LLM 提取出一堆垃圾怎么办？”</p>
...
<p>“第三层是存储时的内容去重。长期记忆在写入前会遍历已有条目，content 完全相同的直接跳过。”</p>` },
      { "t": "拼多多 · 10、MCP 协议解决了什么问题？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王说：“聊聊 MCP。它解决的核心问题是什么？”</p>
...
<p>整个过程是动态的，MCP Server 还能发 notifications/tools/list_changed 通知，Agent 会自动重新拉取工具列表并更新注册。</p>` },
      { "t": "拼多多 · 11、Agent 的上下文窗口满了怎么办？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王问：“上下文窗口快满了，怎么处理？”</p>
...
<p>总摘要以 SUMMARY 类型回注到短期记忆中。同时，压缩过程中还会从旧对话里自动提取持久事实存入长期记忆。</p>` },
      { "t": "拼多多 · 12、RAG 的具体流程", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王若有所思：“行，那说说 RAG。整个 RAG 流程是怎样的？”</p>
...
<p>“第四步检索。用户输入一个自然语言查询，检索器同时走两条路：语义检索和关键词检索，结果合并去重后返回 TopK。”</p>` },
      { "t": "拼多多 · 13、Embedding，RAG 如何检索向量？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王追问：“具体是怎么做混合检索的？”</p>
...
<p>“然后还有一个代码类型加分：method 类型加 0.15，class 类型加 0.10，因为方法和类比整个文件更直接回答‘怎么实现’的问题。最终按总分降序排列，同一个文件最多保留 2 个结果，防止某个大文件霸占所有位置。”</p>` },
      { "t": "拼多多 · 14、Agent 的 Memory 是如何进行管理的？都存在哪些地方？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王问：“总结一下，Agent 的记忆都存在哪些地方？”</p>
<p>我说：“四个地方。”</p>
...
<p>“记忆管理模块是这套系统的门面，统一管理短期记忆、长期记忆、上下文压缩器和记忆检索器。Agent 只和它交互，不直接操作底层的存储。”</p>` },
      { "t": "拼多多 · 15、多 Agent 系统，Agent 之间如何协作？", "tag": "技术派·拼多多", "p": "core", "html": `` },
      { "t": "拼多多 · 文章导读与背景", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王说：“说说多 Agent。系统里 Agent 之间怎么协作？”</p>
...
<p>“步骤之间的上下文传递靠编排器来组装：它把当前步骤所依赖的已完成步骤的结果拼成一段上下文，注入到 Worker 的任务描述里。这样 Worker 不需要看到所有步骤的历史，只看到和自己直接相关的前置结果。”</p>` },
      { "t": "拼多多 · 16、多 Agent 系统的工作流程和生成效果如何去做量化评估？", "tag": "技术派·拼多多", "p": "core", "html": `<p>老王最后问了一个开放题：“这套多 Agent 系统的效果怎么评估？”</p>
...
<p>“判断标准不是产品形态，是有没有『决策、行动、观察结果、再决策』的闭合回路。至于 ReAct 具体怎么转，下一题正好展开。”</p>` },
      { "t": "腾讯面试官 · 02、ReAct Agent 由哪几部分组成", "tag": "技术派·腾讯面试官", "p": "core", "html": `` },
      { "t": "腾讯面试官 · 文章导读与背景", "tag": "技术派·腾讯面试官", "p": "core", "html": `<p>老王点点头。“了解 ReAct Agent 吧？它由哪几部分组成？”</p>
...
<p>“执行上还有两个细节。一个是只读工具最多 4 个并发跑，写操作严格串行，防止互相覆盖；另一个是流式场景下工具调用的参数是分片到达的，要按序号把参数片段拼接完整，再解析成 JSON 交给执行器，拼早了就是半截 JSON，直接解析失败。”</p>` },
      { "t": "腾讯面试官 · 03、设计一个 Agent 框架，会分哪些模块", "tag": "技术派·腾讯面试官", "p": "core", "html": `` },
      { "t": "腾讯面试官 · 文章导读与背景", "tag": "技术派·腾讯面试官", "p": "core", "html": `<p>老王往椅背上一靠。“如果从零设计一个 Agent 框架，会分哪些模块？”</p>
<p>“核心六层：”</p>
...
<p>“好处是每层都能单独替换。换模型只动模型层，加工具只动注册表，改界面只动入口层。”</p>` },
      { "t": "腾讯面试官 · 04、MCP 和 tool 之间有什么联系和区别", "tag": "技术派·腾讯面试官", "p": "core", "html": `` },
      { "t": "腾讯面试官 · 文章导读与背景", "tag": "技术派·腾讯面试官", "p": "core", "html": `<p>老王在本子上记了一笔。“MCP 和 tool 之间的联系和区别，说说看。”</p>
...
<p>“还有个容易被忽略的点。MCP 除了工具还有资源和提示词模板，我把它们也映射成了虚拟工具，列资源、读资源和调用普通工具走的是同一条路径，模型侧不用学新动作。”</p>` },
      { "t": "腾讯面试官 · 05、短期记忆和长期记忆是怎么做的", "tag": "技术派·腾讯面试官", "p": "core", "html": `` },
      { "t": "腾讯面试官 · 文章导读与背景", "tag": "技术派·腾讯面试官", "p": "core", "html": `<p>老王翻了页简历。“项目里的智能问答，短期记忆和长期记忆是怎么做的？”</p>
...
<p>这张表建议存下来，答记忆类的题基本都能套。</p>` },
      { "t": "腾讯面试官 · 06、Skill 的渐进式加载机制了解吗", "tag": "技术派·腾讯面试官", "p": "core", "html": `` },
      { "t": "腾讯面试官 · 文章导读与背景", "tag": "技术派·腾讯面试官", "p": "core", "html": `<p>老王抛出下一问。“了解 Skill 的渐进式披露（progressive disclosure）机制吗？”</p>
...
<p>“说白了就是一个微型搜索引擎，检索对象从网页换成了技能。”</p>` },
      { "t": "腾讯面试官 · 07、使用 AI 时，如何保证输出内容的质量", "tag": "技术派·腾讯面试官", "p": "core", "html": `` },
      { "t": "腾讯面试官 · 文章导读与背景", "tag": "技术派·腾讯面试官", "p": "core", "html": `<p>老王问出最后一道正题。“在使用 AI 时，应该怎么保证输出内容的质量？”</p>
<p>“分三层答，先说我实现了的。”</p>
<ul>
...
<h2>反问</h2>` },
      { "t": "腾讯面试官 · 08、结合面试表现，后端和 Agent 方面怎么学", "tag": "技术派·腾讯面试官", "p": "core", "html": `<p>面试收尾，轮到我反问。“结合我刚才的表现，后端和 Agent 方面能给点学习建议吗？”</p>
...
<blockquote>
 <p>GitHub: <a href="https://github.com/itwanger/PaiCLI-Python">https://github.com/itwanger/PaiCLI-Python</a></p>
      ...
      { "t": "携程 · 01、Claude Code 与 Codex 各自有什么特别？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>老王翻开面试题，直接问：“Claude Code 和 Codex 你都用过吗？各自有什么特别的地方？”</p>
...
<p><img src="assets/jimg/agent-mianshi-xiecheng-20260727130738.png" decoding="async" loading="lazy" fetchpriority="low" width="2578" height="1748"></p>` },
      { "t": "携程 · 02、输入到模型的 prompt 由哪些部分组成？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>“你做的 Agent，输入到模型的 prompt 是怎么组装的？哪些部分是必须注入的，哪些不是？”</p>
...
<p>“Prompt Caching 会按最长公共前缀命中。前 4 层是静态内容，放在提示词最前面，每轮请求的前缀都一样，缓存命中率能拉到最高。如果把动态内容插到前面，前缀每轮都变，缓存基本不会中，token 成本会高出好几倍。”</p>` },
      { "t": "携程 · 03、你做的 coding agent 和 Claude Code 与 Codex 区别在哪？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>“Claude Code 是终端 Agent 的标杆。”</p>
...
<p>做完之后我对Agent系统的每一层都有了源码级的理解，再回去用Claude Code的时候我能明显感觉到我对工具的驾驭能力提升了——我知道什么样的指令能让Agent更准确地理解我的意图、我知道在什么场景下应该手动压缩上下文、我知道怎么设计Tool的描述信息能提高调用准确率。</p>` },
      { "t": "携程 · 04、上下文压缩是怎么做的？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>老王往前倾了倾身子，继续问：“你提到了上下文压缩，具体是怎么做的？”</p>
...
<p>“第三层是紧急降级。如果摘要压缩之后 token 数还是超限，按优先级丢弃非核心上下文——Skills 索引、非关键记忆、项目记忆里优先级低的部分，给核心对话腾空间。”</p>` },
      { "t": "携程 · 05、为什么要采用三层压缩策略？每一层压缩的内容一致吗？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>“设计思路是粒度从细到粗，触发条件从宽到严。”</p>
...
<p>“三层压缩的内容完全不一样。第一层压的是工具输出，第二层压的是对话历史，第三层丢的是辅助上下文。如果只用一层笼统地压缩，要么压得太早浪费上下文空间，要么压得太晚直接超限报错。”</p>` },
      { "t": "携程 · 06、压缩过度效果不理想，怎么发现，怎么处理？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>“靠两个信号。”</p>
...
<p>第三，压缩前备份原始历史，发现效果不好可以回滚到压缩前的状态，用更保守的策略重新压。</p>` },
      { "t": "携程 · 07、增量修改系统怎么做？需要重新注入哪些信息？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>“走的是 Plan 审查机制。”</p>
...
<p>“重新规划让规划器看到全貌，重新安排依赖和执行顺序，避免后续步骤建立在错误的前提上。”</p>` },
      { "t": "携程 · 08、工具调用的流程是怎样的？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>老王翻了一页笔记，继续问：“工具调用这块讲讲，完整流程是什么？”</p>
<p>“三个阶段。”</p>
...
<p>“Tool 是手，Skill 是脑子里的经验。你不能用经验代替手去拧螺丝，也不能用手代替经验去判断该拧哪颗。两个是互补关系，不是替代关系。”</p>` },
      { "t": "携程 · 09、讲讲你的 Skills 有哪些？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>“核心设计思路是渐进式披露，分三层加载。”</p>
...
<p>“Skill 来源有三个优先级：内置的、用户级的、项目级的，从低到高覆盖。项目级的 Skill 可以覆盖内置同名 Skill 的行为，不用改源码。”</p>` },
      { "t": "携程 · 10、工具调用时模型用了几次？Skill 用了几次？", "tag": "技术派·携程", "p": "core", "html": `` },
      { "t": "携程 · 文章导读与背景", "tag": "技术派·携程", "p": "core", "html": `<p>“这个跟任务复杂度有关，说个典型场景。”</p>
...
<h2>场景题</h2>` },
      { "t": "携程 · 11、面向一个复杂任务，你的 coding agent 的 plan 是怎么做的？", "tag": "技术派·携程", "p": "core", "html": `<p>老王合上笔帽，换了个方向：“来道场景题。如果来了一个复杂任务，你的 Agent 会怎么做 plan？”</p>
...
<p>（全文比较肝，保证大家能学到很多很多，系好安全带，我们粗粗粗粗发～）</p>
<h2>场景题</h2>` },
      { "t": "阿里 · 在淘天高并发场景下，将 Agent Demo 改造为能支撑“双十一”级别流量的生产系统，最大的架构挑战是什么？", "tag": "技术派·阿里", "p": "core", "html": `` },
      { "t": "阿里 · 文章导读与背景", "tag": "技术派·阿里", "p": "core", "html": `<p>老王翻了翻简历上的项目经历，开口就是一个很难的场景题：“假设你来我们淘天，要把一个实验性质的 Agent Demo 改造成能扛双十一的生产系统，你觉得最大的架构挑战是什么？”</p>
...
<p>“我的判断——做技术验证和快速原型，用框架。做生产系统，核心自己写，框架当工具库用。”</p>` },
      { "t": "阿里 · 02、如何控制 Agent 的自主性边界？如何设计安全护栏？", "tag": "技术派·阿里", "p": "core", "html": `<p>“自主性边界的核心原则——确定性的规则走规则引擎，模糊的地方交给 LLM 判断，高风险动作交给人工审批。”</p>
...
<blockquote>
 <p>文中涉及的PaiCLI Agent 已经开源到GitHub，Go版本也有：<a href="https://github.com/itwanger/PaiCLI-Python">https://github.com/itwanger/PaiCLI-Python</a></p>
      ...
      { "t": "海康威视 · 01、对 Agent 自进化的理解", "tag": "技术派·海康威视", "p": "core", "html": `` },
      { "t": "海康威视 · 文章导读与背景", "tag": "技术派·海康威视", "p": "core", "html": `<p>老王低头翻着我的简历，无名指上的戒指碰到纸面，发出轻轻的响声。翻到第二页停了下来：“Agent 自进化，你展开聊聊？”</p>
...
<p>第三条，知识库增量。把解决过的问题和方案结构化存入长期记忆。下次遇到同类问题，先检索经验库，不用从零开始推理。</p>` },
      { "t": "海康威视 · 02、自进化产物的提取标准和质量评估", "tag": "技术派·海康威视", "p": "core", "html": `` },
      { "t": "海康威视 · 文章导读与背景", "tag": "技术派·海康威视", "p": "core", "html": `<p>“提取标准有三条。”</p>
...
<p>“可解释维度——提取出来的规则，人类能不能看懂、能不能审核。不可解释的经验不能放进 system prompt，因为你不知道它为什么有效，也不知道它什么时候会失效。”</p>` },
      { "t": "海康威视 · 03、数据从哪来？怎么判断高质量数据？", "tag": "技术派·海康威视", "p": "core", "html": `` },
      { "t": "海康威视 · 文章导读与背景", "tag": "技术派·海康威视", "p": "core", "html": `<p>老王端起茶杯喝了一口：“用于做 Agent 自进化的数据从哪来？”</p>
<p>“三个来源。”</p>
...
<ul>
 ...
 <li>可泛化——不是针对特定文件路径或特定项目结构的 hack。四个条件都满足，才算高质量。</li>
      ...
      { "t": "海康威视 · 04、为什么在沙箱环境做自进化？", "tag": "技术派·海康威视", "p": "core", "html": `` },
      { "t": "海康威视 · 文章导读与背景", "tag": "技术派·海康威视", "p": "core", "html": `<p>“第一，安全。自进化过程中 Agent 会尝试新策略，新策略可能有副作用——删错文件、执行错误命令、改坏代码。在沙箱里犯错不影响真实环境。”</p>
...
<p>“第三，可逆向。策略不好就回滚快照从头再来，成本很低。真实环境里把代码改坏了，回滚的代价要大得多。”</p>` },
      { "t": "海康威视 · 05、快照的选择时机", "tag": "技术派·海康威视", "p": "core", "html": `<p>“你提到快照和回滚，那快照在什么时机做？”</p>
...
<blockquote>
 <p>文中涉及的PaiCLI Agent 已经开源到GitHub，Go版本也有：<a href="https://github.com/itwanger/PaiCLI-Python">https://github.com/itwanger/PaiCLI-Python</a></p>
      ...
      { "t": "长鑫存储 · 01、Agent 系统中的 Memory，与计算机硬件中的 DRAM 有什么联系？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>老王推了推眼镜，翻了翻简历。“开门见山问一个基础的。Agent 系统中的 Memory，和计算机硬件中的 DRAM，有什么联系？”</p>
...
<p>“主板上插了多大的内存条 DRAM 的容量就多大。Agent Memory 的容量受上下文窗口限制，但可以把事实记忆存到磁盘，需要的时候再检索回来注入上下文。”</p>` },
      { "t": "长鑫存储 · 02、大模型上下文变长后，为什么 KV Cache 会快速占用显存和内存？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>“KV Cache 是 Transformer 推理时的核心缓存。每生成一个新 token，模型都要回顾之前所有 token 的 Key 和 Value 向量来计算注意力。如果每次都重新算，计算量会随序列长度平方增长。KV Cache 的做法是把已经算过的 Key 和 Value 缓存下来，新 token 只需要算自己的 Query，然后和缓存里的 Key、Value 做注意力计算。”</p>
...
<p><img src="assets/jimg/agent-mianshi-changxin-20260804122919-af11c817.png" decoding="async" loading="lazy" fetchpriority="low" width="1672" height="941"></p>` },
      { "t": "长鑫存储 · 03、大模型推理什么时候是算力瓶颈，什么时候是内存带宽瓶颈？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>老王端起茶杯喝了口水。“接着上一题，推理的瓶颈不是一直不变的。什么时候卡算力，什么时候卡带宽？”</p>
...
<p>“一句话概括就是，Prefill 阶段是算得慢，Decode 阶段是读得慢。”</p>` },
      { "t": "长鑫存储 · 04、多 Agent 并发运行为什么更容易产生 OOM？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>“原因是每个 Agent 都有自己独立的内存开销，N 个 Agent 并发就是 N 倍。”</p>
...
<p>“多 Agent 并发的问题在于，这些开销不共享。每个 Agent 有自己的对话历史，有自己的工具调用结果，有自己的任务状态。就算 system prompt 相同可以共享缓存，动态生成的部分也没办法复用。”</p>` },
      { "t": "长鑫存储 · 05、Agent 的工作记忆、情景记忆和长期记忆应该如何分层？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>老王放下茶杯，翻了翻简历背面。“说说你对 Agent 记忆分层的理解。工作记忆、情景记忆、长期记忆，怎么分？”</p>
...
<p>“第二，注意力稀释。Transformer 的注意力机制在上下文越长的时候，对每个 token 的关注度越分散。塞进去太多无关信息，模型反而更容易忽略真正重要的内容。分层的目的就是让工作记忆里只保留当前任务最需要的信息，其余的按需检索。”</p>` },
      { "t": "长鑫存储 · 06、Redis、向量数据库、关系数据库和对象存储分别适合保存什么 Agent 数据？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>“Redis 适合存会话状态和短期缓存。Agent 的当前会话 ID、最近几轮对话历史、工具调用的临时结果，这些数据访问频率高、生命周期短。Redis 的读写速度快，TTL（自动过期）机制能自动清理过期数据。PaiCLI 的会话状态就存在 Redis 里，7 天自动过期。”</p>
...
<p>“对象存储适合存大文件和长期归档。用户上传的文档、Agent 生成的报告、对话历史的原始日志，数据量大但访问频率低。对象存储容量大、成本低，适合做冷数据的落盘。”</p>` },
      { "t": "长鑫存储 · 07、如何设计上下文压缩，避免 Agent 运行时间越长、Token 消耗越大？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>老王看了一眼手表，无名指上的戒指反了一下光。“上下文管理是 Agent 工程化绕不开的问题。聊聊你们怎么做压缩的。”</p>
<p>“思路是‘近处保全、远处摘要’。”</p>
...
<p>“当然，如果 LLM 摘要调用失败了，PaiCLI 也会降级到简单截断。”</p>` },
      { "t": "长鑫存储 · 08、KV Cache 量化、分页和卸载分别解决什么问题？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>“量化解决的是‘单个 KV 太大’的问题。把 KV Cache 从 BF16 精度降到 INT8，每个元素从 2 字节变成 1 字节，显存占用直接减半。INT8 量化几乎无损，对生成质量的影响很小。继续降到 INT4 可以再减半，但精度损失会比较明显，适合对质量要求不那么高的场景。”</p>
...
<p>“卸载解决的是‘显存放不下’的问题。把暂时用不到的 KV Cache 搬到 SSD 上，需要的时候再搬回来。本质是拿延迟换容量，适合超长上下文的离线任务。”</p>` },
      { "t": "长鑫存储 · 09、一个长时间运行的 Agent，如何实现状态持久化和故障恢复？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>“靠快照机制。”</p>
...
<p>“数据库事务保障的是单行或多行数据的原子性。但 Agent 的状态横跨对话历史、记忆存储、任务进度、工具调用结果，这些可能分布在不同的存储里。跨存储的分布式事务成本太高，快照做全量保存、恢复时全量加载，反而更简单可靠。”</p>` },
      { "t": "长鑫存储 · 10、如果 Agent 突然出现延迟升高，应当监控 Token、显存、内存和工具调用中的哪些指标？", "tag": "技术派·长鑫存储", "p": "core", "html": `` },
      { "t": "长鑫存储 · 文章导读与背景", "tag": "技术派·长鑫存储", "p": "core", "html": `<p>老王把简历翻回正面放好。“最后一题，偏实际运维的。Agent 突然变慢了，你怎么排查？”</p>
<p>“分四个维度看。”</p>
...
<p><img src="assets/jimg/agent-mianshi-changxin-20260804132023-491a22dc.png" decoding="async" loading="lazy" fetchpriority="low" width="1672" height="941"></p>` },
      { "t": "长鑫存储 · PaiCLI 如何写到简历上？", "tag": "技术派·长鑫存储", "p": "core", "html": `<p><strong>项目名称</strong>：PaiCLI — 终端 AI Agent 命令行工具</p>
