window.LINKS = {
  groups: [
    {
      name: "我的整理（本地笔记）",
      note: "6 份本地 Markdown 笔记，已拆分为 6 个独立 Tab：586 题、52 章，含完整答案（点击卡片直达对应笔记）",
      items: [
        ...
        { key: "mine-jishu", icon: "🌊", title: "paicil_技术派", token: "", status: "mine", note: "162 题 · 15 章（17-24 教学节 + 25-31 Agent 面试篇）· 含 146 张配图", local: true }
      ]
    },
    {
      name: "必备技术栈",
