  ...
  groups: [
    {
      ...
      items: [
        ...
        { key: "mine", icon: "🤖", title: "agent面经收集", token: "", status: "mine", note: "30 题 · 哔哩AI / 联影 / 影石 / 小厂面经", local: true },
        { key: "mine", icon: "🗂️", title: "派聪明QORDER_NOTE", token: "", status: "mine", note: "68 节 · RAG 项目 10 大模块 58 技术点 / 上传·解析·向量·Agent·安全·计费等", local: true }
      ]
    },
    {
      name: "必备技术栈",
